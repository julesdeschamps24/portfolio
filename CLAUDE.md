# CLAUDE.md - Jules Deschamps, créateur de sites internet (site vitrine)

Ce dépôt est le site vitrine de Jules Deschamps, créateur de sites internet indépendant.
Ce fichier donne le contexte durable et les règles à respecter dans toute session de travail.
...
**Jules Deschamps, créateur de sites internet indépendant.** Ce dépôt est son **site vitrine**,
...
> **Nom de marque : « Jules Deschamps » partout** (décision 2026-07-16). Le mot
> **« studio » est abandonné** : « ça peut faire un peu trop pour le moment », Jules se
> présente comme **créateur de sites internet indépendant**. Ne dire « studio » nulle part
> (la classe CSS `.studio` est un simple scope, elle ne compte pas). L'ancien nom « Node4 »
> reste abandonné lui aussi (y compris, à terme, dans les mentions légales).
...
de secteur cible - on repart de zéro sur le positionnement ci-dessous.

### Objectif
**Vendre des sites web aux commerces & artisans locaux.** Ce n'est plus un portfolio de dev :
c'est l'outil commercial d'un créateur de sites internet indépendant.
...
### DA
⚠️ **PÉRIMÉ** : le cobalt vibrant décrit ici a été **abandonné** (Jules veut des couleurs plus
sobres). La DA en vigueur est **« Os & encre »** : voir `style.md`, qui fait autorité sur tout
ce qui est visuel. Ne pas se fier à cette section.
...
2. **Marque** : ✅ **« Jules Deschamps »** partout (revu le 2026-07-16 : plus de « studio », cf. §1).
3. **Ton vs DA** : ✅ voir `style.md`. À garder à l'œil pour que ça reste « pro & rassurant ».
